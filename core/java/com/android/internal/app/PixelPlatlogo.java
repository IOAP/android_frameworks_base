/*
 * Copyright (C) 2010 The PixelROM Project
 *
...
public class PixelPlatlogo extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
            ...
            tv.setText("PixelROM 1.0 - Android " + Build.VERSION.RELEASE);
            ...
            logo.setOnLongClickListener(new View.OnLongClickListener() {
                ...
                public boolean onLongClick(View v) {
                    ...
                    try {
                        ...
                        android.util.Log.e("PixelPlatlogo", "Couldn't catch a break.");
                    }
                    finish();
                    return true;
                }
